...
import { PlusIcon, Search, ArrowRight, Settings, BarChart } from 'lucide-react'
...
const initialFlows = [
    {
        ...
        status: 'Active',
        steps: [
            { id: 1, type: 'message', content: 'Welcome to our service!' },
            { id: 2, type: 'input', content: 'Enter 1 for English, 2 for Spanish' },
            { id: 3, type: 'condition', content: 'if input == 1 goto 4 else goto 5' },
            { id: 4, type: 'message', content: 'You selected English' },
            { id: 5, type: 'message', content: 'You selected Spanish' }
        ],
    ...
    },
    {
        ...
        status: 'Active',
        steps: [
            { id: 1, type: 'input', content: 'Please enter your order number' },
            { id: 2, type: 'api', content: 'GET /api/order/{input}' },
            { id: 3, type: 'condition', content: 'if order_status == "shipped" goto 4 else goto 5' },
            { id: 4, type: 'message', content: 'Your order has been shipped' },
            { id: 5, type: 'message', content: 'Your order is being processed' }
        ],
...
export default function AutomationDashboard() {
    ...
    const handleAddStep = (type: string) => {
        if (selectedFlow) {
            const newStep = {
                id: selectedFlow.steps.length + 1,
                type,
                content: type === 'message' ? 'Enter message' : type === 'input' ? 'Enter prompt' : 'Enter condition'
            }
            const updatedFlow = {
                ...selectedFlow,
    ...
    const handleUpdateStep = (stepId: number, content: string) => {
        if (selectedFlow) {
