...
import { PlusIcon, Search, ArrowRight, Settings, BarChart, Save, MessageSquare, PhoneCall, AlertCircle, Variable, Clock } from 'lucide-react'
                            ...
                            <div className="w-1/3 pr-4 flex flex-col">
                                ...
                                <ScrollArea className="flex-1" ref={stepsRef}>
                                    {selectedFlow.steps.map((step, index) => (
                                        <div key={step.id} className="flex flex-col space-y-2 mb-4" data-step-id={step.id}>
                                            <div className={`flex items-center space-x-2 p-2 rounded ${step.data.isSelected ? 'bg-blue-100' : ''}`}>
                                                <Badge>{index + 1}</Badge>
